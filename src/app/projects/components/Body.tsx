...
export function Body() {
    return (
        <div className="flex flex-col justify-center items-center bg-custom-gradient space-y-16 pt-24 px-4 min-h-screen w-full">
            <span className="text-2xl md:text-4xl font-mono mb-8 text-center">
                Projetos em que participo ativamente
            </span>
            <div className="flex flex-col space-y-8">
                <div className="flex flex-col md:flex-row items-center md:space-x-8">
                    <div className="border-4 border-gray-300 p-4 mb-4 flex flex-col items-center">
                        ...
                        <a href="https://github.com/devhatt/pet-dex-backend" target="_blank" rel="noopener noreferrer" className="bg-amber-600 text-white px-4 py-2 rounded hover:bg-amber-800 transition duration-300 mt-4">
                            Código
                        </a>
                    </div>
                    <p className="text-sm md:text-base max-w-md font-mono text-center">
                ...
                <div className="flex flex-col md:flex-row items-center md:space-x-8">
                    <div className="border-4 border-gray-300 p-4 mb-4 flex flex-col items-center">
                        ...
                        <a href="https://github.com/devhatt/octopost-backend" target="_blank" rel="noopener noreferrer" className="bg-amber-600 text-white px-4 py-2 rounded hover:bg-amber-800 transition duration-300 mt-4">
                            Código
                        </a>
                    </div>
                    <p className="text-sm md:text-base max-w-md font-mono text-center">
